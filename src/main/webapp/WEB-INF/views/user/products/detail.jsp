...
<div class="well well-small">
	...
	<div class="row-fluid">
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src="<c:url value="/assets/user/img/${product.get(0).img}"></c:url>" alt="" style="width:100%"></a>
                  </div>
                  <div class="item">
                     <a href="#"> <img src="<c:url value="/assets/user/img/${product.get(0).img}"></c:url>" alt="" style="width:100%"></a>
                  </div>
			...
			<div class="span7">
				<h3>${product.get(0).name } [$<fmt:formatNumber
												type="number" groupingUsed="true" value="${product.get(0).price}" />]</h3>
				<hr class="soft"/>
				
				<form class="form-horizontal qtyFrm" method="get" action="<c:url value="/AddCart/${product.get(0).id_product}"></c:url>">
				  <div class="control-group">
					<label class="control-label"><span>$<fmt:formatNumber
												type="number" groupingUsed="true" value="${product.get(0).price}" /></span></label>
					<div class="controls">
            ...
            <div class="tab-pane fade active in" id="home">
			  <h4>Product Information</h4>
				...
				<p>${product.get(0).detail}</p>

			</div>
			<div class="tab-pane fade" id="profile">
			<c:set var="countList" value="${productsRela.size() }"></c:set>
			<c:if test="${productsRela.size() > 5}">
			<c:set var="countList" value="5"></c:set>
			</c:if>
			<c:forEach var="item" begin="1" end="${countList}" items="${productsRela }">
